            ...
            <div {...handlers} className="zodiac-detail">
                <div className="head">
                    <button className="back-button" onClick={onBack}>
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M8.45776 12.4918L4.00728 8.03337H13.8667V5.9667H4.00789L8.46672 1.50787L6.99955 0.0510254L0.0505371 7.00004L7.00005 13.9495L8.45776 12.4918Z" fill="#94A2AC"></path></svg>
                    </button>
